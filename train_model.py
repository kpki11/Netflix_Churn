...
def logical_cleaning(df: pd.DataFrame) -> pd.DataFrame:
    """Apply simple logical cleaning rules."""
    ...
    # Category 3: Behavioural outliers (rough example logic)
...
def winsorize_column(
    ...
    """Clip extreme values of a column to given quantiles."""
...
def train_and_save(path: str = DATA_PATH) -> None:
